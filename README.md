...
- Taktik-Board: Fußballfeld zum Zusammenstellen der benötigten Positionen samt Starter-Anzahl. Formations-Presets (4-4-2, 4-3-3, 4-2-3-1, 3-5-2/Dreierkette, 5-3-2, 4-1-4-1) setzen automatisch passende Marker; danach frei per Drag & Drop verschiebbar, zusätzliche Positionen hinzufügbar/entfernbar. Die horizontale Lage eines Markers bestimmt die Seite (links/zentral/rechts, sichtbar als Zonen-Raster mit Live-Beschriftung); mehrere Marker in derselben Zone (z.B. 2x "V" zentral) zählen als 2 Innenverteidiger-Starter
